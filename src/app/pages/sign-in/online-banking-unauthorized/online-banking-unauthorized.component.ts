...
@Component({
  selector: 'app-online-banking-unauthorized',
  templateUrl: './online-banking-unauthorized.component.html',
  styleUrls: ['./online-banking-unauthorized.component.css'],
})
export class OnlineBankingUnauthorizedComponent implements OnInit {
  constructor(
