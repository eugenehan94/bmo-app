        ...
        children: [
          {
            ...
            ariaLabel: 'Banking options for students, Offers, bonuses and more',
  ...
  },
  {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            ariaLabel: 'Air miles credit card, For travel, merchandise & more',
            icon: 'assets/svg/airmiles-blue.svg',
            alt: 'Blue plane',
            title: 'AIR MILES',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            ariaLabel: 'Pre-paid credit cards, A reloadable, secure Mastercard',
    ...
    resources: [
      ...
      },
      {
        ...
        ariaLabel: 'Help me choose a credit card, Answer a few short questions',
        icon: 'assets/svg/helpme-choose-blue.svg',
  ...
  },
  {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            ariaLabel: 'Mortgage pre-approval, learn more about pre-approvals',
          ...
          },
          {
            ...
            ariaLabel: 'Refinance your mortgage, fund your goals and big plans',
    ...
    resources: [
      ...
      },
      {
        ...
        ariaLabel: 'Talk to an expert, Request a call back, opens in a new tab',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            ariaLabel: 'Learn more about auto loans, Get the vehicle you want',
  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        ...
        children: [
          {
            link: 'https://www.bmo.com/main/personal/investments/online-investing/?icid=tl-FEATINV1-KGBMOH14',
            ariaLabel: 'Online investing overview',
            icon: 'assets/svg/all-layers-blue.svg',
            alt: 'Blue layers',
            title: 'All online investing solutions',
            description: 'Explore your options',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/online-investing/investorline/self-directed/?icid=tl-FEAT2953BRND4-AJBMOH159',
            ariaLabel: 'Investor Line self directed investing',
            icon: 'assets/svg/trend-blue.svg',
            alt: 'Blue upwards trending arrow',
            title: 'InvestorLine Self-Directed',
            description: 'Trade Online',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/online-investing/investorline/advicedirect/?icid=tl-FEAT2953BRND4-AJBMOH160',
            ariaLabel:
              'Investor Line advice direct, trading online with expert advice',
            icon: 'assets/svg/chat-bubbles-money-blue.svg',
            alt: 'Two blue chat bubbles, one with dollar sign',
            title: 'InvestorLine adviceDirect',
            description: 'Trading online with expert advice',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/online-investing/smartfolio/?icid=tl-FEAT2953BRND4-AJBMOH161',
            ariaLabel: 'B M O Smart folio, let us invest for you',
            icon: 'assets/svg/portfolio-icon-blue.svg',
            alt: 'Blue portfolio',
            title: 'BMO SmartFolio',
            description: 'Let us invest for you',
          },
        ],
      },
      {
        ...
        children: [
          {
            link: 'https://www.bmo.com/main/personal/investments/tfsa/?icid=tl-FEAT2953BRND4-AJBMOH162',
            ariaLabel: 'Tax-free Savings account, Grow your money, tax free',
            icon: 'assets/svg/shield-money-blue.svg',
            alt: 'Blue shield with dollar sign',
            title: 'TFSA',
            description: 'Grow your money, tax free',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/rrsp/?icid=tl-FEAT2953BRND4-AJBMOH163',
            ariaLabel:
              'Registered Retirement Savings Plan, Invest for your retirement',
            icon: 'assets/svg/money-rrsp-blue.svg',
            alt: 'Blue nest egg with dollar sign',
            title: 'RRSP',
            description: 'Invest for your retirement',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/resp/?icid=tl-FEAT2953BRND4-AJBMOH164',
            ariaLabel:
              'Registered Education Savings Plan, Save for a child’s education',
            icon: 'assets/svg/graduation-hat-blue.svg',
            alt: 'Blue graduation hat with dollar sign',
            title: 'RESP',
            description: 'Save for a child’s education',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/fhsa/?icid=tl-FEATINV1-KGBMOH16',
            ariaLabel: 'Learn about the First Home Savings Account',
            icon: 'assets/svg/house-dollar-blue.svg',
            alt: 'Blue house with dollar sign',
            title: 'FHSA (Coming soon)',
            description: 'Save for the purchase of your first home',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/rrif/?icid=tl-FEAT2953BRND4-AJBMOH165',
            ariaLabel:
              'Registered retirement income fund, Manage your retirement income',
            icon: 'assets/svg/hand-cross-blue.svg',
            alt: 'Blue hand with percentage sign',
            title: 'RRIF',
            description: 'Manage your retirement income',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/rdsp/?icid=tl-FEAT2953BRND4-AJBMOH166',
            ariaLabel: 'Registered disability savings plan',
            icon: 'assets/svg/rdsp-icon-blue.svg',
            alt: 'Blue person outline on wheelchair',
            title: 'RDSP',
            description: 'Registered disability savings',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/margin-accounts/?icid=tl-FEAT2953BRND4-AJBMOH167',
            ariaLabel: 'Margin accounts, leverage your investments',
            icon: 'assets/svg/margins-accounts-blue.svg',
            alt: 'Blue pie chart with one quarter slice separated from whole',
            title: 'Margin Accounts',
            description: 'Leverage your investments',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/csp/?icid=tl-FEAT2953BRND4-AJBMOH168',
            ariaLabel: 'Continuous savings plan, Save on a regular basis ',
            icon: 'assets/svg/calendar-money-blue.svg',
            alt: 'Blue calendar with dollar sign',
            title: 'CSP',
            description: 'Save on a regular basis',
          },
        ],
      },
      {
        ...
        children: [
          {
            link: 'https://www.bmo.com/main/personal/investments/mutual-funds/?icid=tl-FEAT2953BRND4-AJBMOH169',
            ariaLabel: 'Mutual funds, diversified and managed investing',
            icon: 'assets/svg/briefcase-trend-blue.svg',
            alt: 'Blue briefcase with up trending arrow',
            title: 'Mutual Funds',
            description: 'Diversified and managed investing',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/gic/?icid=tl-FEAT2953BRND4-AJBMOH170',
            ariaLabel:
              'Guaranteed investment certificates, Guarantee your return',
            icon: 'assets/svg/money-ribbon-blue.svg',
            alt: 'Blue money bill with ribbon',
            title: 'GICs',
            description: 'Guarantee your return',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/etf/?icid=tl-FEAT2953BRND4-AJBMOH171',
            ariaLabel: 'Exchange traded funds, Diversified and easy to trade',
            icon: 'assets/svg/spread-blue.svg',
            alt: 'Blue spread with dollar sign in center',
            title: 'ETFs',
            description: 'Diversified and easy to trade',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/stocks/?icid=tl-FEAT2953BRND4-AJBMOH172',
            ariaLabel: 'Stocks, invest in specific companies',
            icon: 'assets/svg/investment-payout-blue.svg',
            alt: 'Blue investment with up trending arrow',
            title: 'Stocks',
            description: 'Invest in specific companies',
          },
          {
            link: 'https://www.bmo.com/main/personal/investments/bonds/?icid=tl-FEAT2953BRND4-AJBMOH173',
            ariaLabel: 'Bonds, predictable investment returns',
            icon: 'assets/svg/bonds-cross-blue.svg',
            alt: 'Blue bond with percentage sign',
            title: 'Bonds',
            description: 'Predictable investment returns',
          },
        ],
      },
      {
        ...
        children: [
          {
            link: 'https://www.bmo.com/main/personal/investments/rrsp-calculator/?icid=tl-FEAT2953BRND4-AJBMOH174',
            ariaLabel:
              'Retirement calculator, make the most of your retirement',
            icon: 'assets/svg/retirement-calculator-blue.svg',
            alt: 'Blue beach tree with sun',
            title: 'Retirement Calculator',
            description: 'Make the most of your retirement',
          },
          {
